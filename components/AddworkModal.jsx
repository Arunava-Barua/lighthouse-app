...
//     const res = await addWork(workForm);
...
//     let fileLink = `https://gateway.lighthouse.storage/ipfs/${output.data.Hash}`;
//     setWorkForm({ ...workForm, uploadFile: fileLink });
...
//   return (
//     <div className='w-[500px] h-[100vh] bg-[#1a1a1d] border border-[#313134] rounded-[20px] text-white flex flex-col items-start justify-between z-30 p-[20px] relative'>
//       <button
